# JFo 3-1 - Actividad 05

## Corrige la reutilizacion incorrecta de variables

Usa variables separadas cuando los datos tienen tipos diferentes.
...
2. Abre `src/main/java/modulo3_1_actividad05/Actividad05.java`.
3. Corrige o completa el codigo.
4. Ejecuta `Run As > Java Application`.
5. Ejecuta los tests desde `src/test/java/modulo3_1_actividad05/Actividad05Test.java` con `Run As > JUnit Test`.
