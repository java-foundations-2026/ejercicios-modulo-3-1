# JFo 3-1 - Actividad 14

## Crea una factura basica con variables

Calcula subtotal, impuesto y total a partir de variables.
...
2. Abre `src/main/java/modulo3_1_actividad14/Actividad14.java`.
3. Corrige o completa el codigo.
4. Ejecuta `Run As > Java Application`.
5. Ejecuta los tests desde `src/test/java/modulo3_1_actividad14/Actividad14Test.java` con `Run As > JUnit Test`.
