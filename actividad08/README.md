# JFo 3-1 - Actividad 08

## Crea un programa de datos de una mascota

Guarda nombre, especie, edad y peso de una mascota en variables.
...
2. Abre `src/main/java/modulo3_1_actividad08/Actividad08.java`.
3. Corrige o completa el codigo.
4. Ejecuta `Run As > Java Application`.
5. Ejecuta los tests desde `src/test/java/modulo3_1_actividad08/Actividad08Test.java` con `Run As > JUnit Test`.
